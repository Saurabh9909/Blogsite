        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ol>
                    ...
                    <li>{{substr($blogDetails->blog_title, 0, 10)}}</li>
                </ol>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img">
                            <img src="{{ asset($blogDetails->blog_poster ?? "") }}" alt="" class="img-fluid">
                        </div>

                        <h2 class="entry-title">
                            <a href="">{{$blogDetails->blog_title ?? ""}}</a>
                        </h2>

                        <div class="entry-meta">
                            <ul>
                                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                                        href="">{{ $blogDetails->user_id }}</a></li>
                                <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href=""><time
                                            datetime="2020-01-01">{{ date_format($blogDetails->created_at, 'Y-F-m')}}</time></a>
                                </li>
                    ...
                    <div class="blog-author d-flex align-items-center">
                        <img src="{{ asset("assets/img/blog/blog-author.jpg") }}" class="rounded-circle float-left"
                            alt="">
                        <div>
                            <h4>Jane Smith</h4>
                        ...
                        <div class="sidebar-item recent-posts">
                            @foreach ($recentBlogs as $key => $data)
                                <div class="post-item clearfix">
                                    <img src="{{ asset($data->blog_poster) }}" alt="">
                                    <h4><a
